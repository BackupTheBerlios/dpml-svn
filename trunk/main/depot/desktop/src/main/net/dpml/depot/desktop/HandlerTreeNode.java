 ...
 */
public final class HandlerTreeNode extends Node
{
    ...
    public HandlerTreeNode( ApplicationProfile profile )
    {
        super( profile );
        m_profile = profile;
        m_label = new JLabel( "Controller", m_icon, SwingConstants.LEFT );

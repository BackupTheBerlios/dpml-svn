...
public class ActivationGroupTableModel extends AbstractTableModel
{
    ...
    */
    private static final Icon FEATURE_ICON = 
      IconHelper.createImageIcon( 
        ActivationGroupTableModel.class.getClassLoader(), ICON_PATH, "Features" );
    ...
    */
    ...
    private class RemoteListener extends UnicastRemoteObject implements ActivationGroupListener
    {
        ...
        */
        public void profileAdded( ActivationGroupEvent event ) throws RemoteException
        {
        ...
        * @param event the depot event
        */
        public void profileRemoved( ActivationGroupEvent event ) throws RemoteException
        {
            fireTableStructureChanged();
        }
    }

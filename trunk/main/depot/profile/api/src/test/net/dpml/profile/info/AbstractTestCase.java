...
/**
 * The AbstractTestCase class is an abstract utility base class for testcases in this package.
 *
...
abstract class AbstractTestCase extends TestCase
{
        ...
        throws Exception
    {
        ...
        assertEquals( "equal", object, serialized );
        assertEquals( "hashcode", object.hashCode(), serialized.hashCode() );
    }
    ...
    public Object doEncodingTest( Object object, String filename ) throws Exception
    {
        ...
        assertEquals( "equal", object, result );

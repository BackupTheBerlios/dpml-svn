...
public class ValueDescriptor extends AbstractDescriptor
{
    ...
    private final ValueDescriptor[] m_args;
    ...
    */
    public ValueDescriptor( String value )
    {
        this( null, value );
    }
    ...
    * may be either a classname or a symbolic reference in the form ${[key]}.
    *
    * @param target a classname or symbolic reference
    * @param value the construct value
    */
    public ValueDescriptor( String target, String value )
    {
    ...
    * @param value the construct value
    */
    public ValueDescriptor( String target, String method, String value )
    {
        super();
        m_target = target;
        m_method = method;
        m_value = value;
        m_args = new ValueDescriptor[0];
        m_compound = false;
    }
    ...
    */
    public ValueDescriptor( String target, ValueDescriptor[] args )
    {
    ...
    * @param args an array of unresolved parameter values
    */
    public ValueDescriptor( String target, String method, ValueDescriptor[] args )
    {
        super();
        if( null == args )
        {
    ...
    */
    ...
    {
        if( super.equals( other ) && ( other instanceof ValueDescriptor ) )
        {
            ValueDescriptor construct = (ValueDescriptor) other;

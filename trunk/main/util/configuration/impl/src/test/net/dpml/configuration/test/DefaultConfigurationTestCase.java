...
import net.dpml.configuration.impl.MutableConfiguration;
...
public final class DefaultConfigurationTestCase extends TestCase
{
    ...
    public void testCopying(  ) throws Exception
    {
        ...
        DefaultConfiguration modifiableChild1 = new DefaultConfiguration( root.getChild( 
                    "child1" ) );
    ...
    public void testSetToNull(  ) throws Exception
    {
        ...
        try
        {
            ...
            fail( 
                "attribute 'integer' was present despite it being set to null" );
        }
        ...
        throws Exception
    {
        DefaultConfiguration conf = new DefaultConfiguration( "root", "0:0",
                "http://root", "root" );
        DefaultConfiguration child1 = new DefaultConfiguration( "child", "0:1",
        ...
        DefaultConfiguration child2 = new DefaultConfiguration( "child", "0:2",
                "http://root/child", "child" );

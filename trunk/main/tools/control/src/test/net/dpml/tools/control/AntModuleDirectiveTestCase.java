...
import net.dpml.tools.control.LibraryDirectiveBuilder;
 ...
 */
public class AntModuleDirectiveTestCase extends AbstractTestCase
{   
    private ModuleDirective m_module;
    
    public void setUp() throws Exception
    {
        m_module = load( "ant.xml" );
    }
    ...
    public void testResourceCount() throws Exception
    {
        ...
        assertEquals( "resource-count", 2, size );
    }
    
    public void testEncoding() throws Exception
    {
        doEncodingTest( m_module, "ant-module-descritor.xml" );
    }

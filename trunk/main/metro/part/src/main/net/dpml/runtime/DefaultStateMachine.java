...
class DefaultStateMachine implements StateMachine, EventQueue.EventHandler
{
    ...
    */
    ...
    private final WeakHashMap<StateListener,Void> m_listeners = new WeakHashMap<StateListener,Void>();
    ...
    */
    ...
    {
        checkDisposed();
        Hashtable<String,Transition> table = new Hashtable<String,Transition>();
    ...
    */
    ...
    {
        checkDisposed();
        Hashtable<String,Interface> table = new Hashtable<String,Interface>();
        State[] states = m_state.getStatePath();
        for( int i=( states.length-1 ); i>-1; i-- )
        {
            State state = states[i];
    ...
    */
    ...
    private State initialize( List<Action> list, Object object ) throws Exception
    {

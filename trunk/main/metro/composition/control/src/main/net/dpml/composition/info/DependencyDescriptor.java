 ...
 * @version $Id: DependencyDescriptor.java 2387 2005-04-23 19:12:58Z mcconnell@dpml.net $
 */
public final class DependencyDescriptor extends Descriptor
{
     ...
     * @exception NullPointerException if the role argument or the service argument is null.
     */
    public DependencyDescriptor( final String role,
                                 final ReferenceDescriptor service,
                                 final boolean optional,
